...
import { Table, Row, Col, Input, DatePicker, Button, Select, message, Divider, AutoComplete  } from 'antd';
...
import UserArticleModel from './UserArticleAudit.Modal';
import UserArticleDetails from './UserArticleDetails';
...
class UserArticleList extends Component {
    ...
    /*handlePageChange = (page, pageSize) => {
        ...
        this.getUserArticleList(Object.assign({ pageIndex: page }, this.getFilter()));
    }*/
    ...
    render() {
        ...
        const { startDate, endDate, userName, telphone, type, status, auditor, auditStartDate, auditEndDate, allOperator } = this.state;
        return (
            <div>
                {/* 查询条件 */}
                <Row gutter={16}>
