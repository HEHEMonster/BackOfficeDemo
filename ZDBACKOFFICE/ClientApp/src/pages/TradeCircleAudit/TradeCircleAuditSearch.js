...
class TradeCircleAuditSearch extends Component {
    constructor(props) {
        super(props);
        this.state = {};
    }
...
TradeCircleAuditSearch = Form.create({ name: 'tradeCircle_search' })(TradeCircleAuditSearch);

export default TradeCircleAuditSearch;